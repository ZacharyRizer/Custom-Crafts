...
const ShipPage = (props) => {
  ...
  return (
    <>
      {(!Number.isInteger(intID) || intID < 1 || intID > 20) && (
        <Redirect to="/404" />
      )}
      {ship && (
                ...
                <Frame
                  ...
                  <Content
                    ...
                    <Button
                      animate
                      layer="primary"
                      buttonProps={{ id: 'blue', onClick: setColor }}>
                      Blue
                    ...
                    <Button
                      animate
                      layer="success"
                      buttonProps={{ id: 'green', onClick: setColor }}>
                      Green
                      <i className="mdi mdi-drag-vertical" />
                      {shipColor === 'green' ? (
                        <i className="mdi mdi-checkbox-blank" />
                    ...
                    <Button
                      animate
                      layer="secondary"
                      buttonProps={{ id: 'orange', onClick: setColor }}>
                      Orange
                      <i className="mdi mdi-drag-vertical" />
                      {shipColor === 'orange' ? (
                        <i className="mdi mdi-checkbox-blank" />
                    ...
                    <Button
                      animate
                      layer="alert"
                      buttonProps={{ id: 'red', onClick: setColor }}>
                      Red
                      <i className="mdi mdi-drag-vertical" />
                      {shipColor === 'red' ? (
                        <i className="mdi mdi-checkbox-blank" />
