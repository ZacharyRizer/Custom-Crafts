    ...
    <div>
      <div>
        ...
        <Paragraph className="plax">
          Welcome to Cruising Crafts! Check out our great Summer Sale! Prices
          half off all SpaceShips!
        </Paragraph>
      </div>
      ...
      <div>
        ...
        <Paragraph className="plax">
          We've got Luxury spacecrafts, Combat Shuttles, and Performance Racers
          for those with a little fast and furious in their genes!
        </Paragraph>
      </div>
      ...
      <div>
        ...
        <div>
          ...
          <Paragraph className="plax">
            We've got Luxury spacecrafts, Combat Shuttles, and Performance
            Racers for those with a little fast and furious in their genes!
          </Paragraph>
        </div>
        <div className="parallaxTwo"></div>
        <div>
          ...
          <Paragraph className="plax">
            The best deals in the Universe ranging from $599,999 to $999,999
          </Paragraph>
        </div>
