...
import { Row, Col, Frame, Button, Footer, Line, Content, Words, Heading } from "arwes";
...
const Splash = () => {
  ...
  return (
    <>
      ...
      <Footer animate style={{ position: "fixed", left: 0, bottom: 0, width: "100%", zIndex: 100 }}>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            ...
            <a href="https://www.linkedin.com/in/abdullah-wafy/">
              <Button layer="secondary" style={{ marginRight: 10, marginLeft: 10 }} animate>
